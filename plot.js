function init() {
  ...
  function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
      ...
      var sample_otu_ids_top10 = sample_otu_ids.sort((a ,b) => b - a).slice(0,10);
      sample_otu_ids_top10.reverse();
      console.log(sample_otu_ids_top10);
  
      sample_values_top10 = sample_otu_ids_top10.map((id) =>
                  firtSample.sample_values[firtSample.otu_ids.indexOf(id)]);    
      
      sample_otu_labels_top10 = sample_otu_ids_top10.map((id) =>
                  firtSample.otu_labels[firtSample.otu_ids.indexOf(id)]);                   
